...
df.trimmed = read.csv(file.path(input_dir, "cores_with_PCR.csv"))
...
# Temperature-based model outputs
write.csv(temperature.biomass, file = "Origin_temperature_model_total_biomass.csv", row.names = FALSE, col.names = TRUE)
write.csv(temperature.error, file = "Origin_temperature_model_error.csv", row.names = FALSE, col.names = TRUE)
write.csv(temperature.byGridResult, file = "Origin_temperature_model_grid_result.csv", row.names = FALSE, col.names = TRUE)
write.csv(temperature.parameters, file = "Origin_temperature_model_parameters.csv", row.names = FALSE, col.names = TRUE)

# Depth-based model outputs
write.csv(lm.biomass, file = "Origin_depth_model_total_biomass.csv", row.names = FALSE, col.names = TRUE)
write.csv(lm.error, file = "Origin_tdepth_model_error.csv", row.names = FALSE, col.names = TRUE)
write.csv(lm.byGridResult, file = "Origin_depth_model_grid_result.csv", row.names = FALSE, col.names = TRUE)
write.csv(lm.parameters, file = "Origin_depth_model_parameters.csv", row.names = FALSE, col.names = TRUE)
